  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      const newWidth = Math.max(
        startWidth + diff,
        columnWidths[columnId] || startWidth
      ...
      >
          ...
          <div className="flex items-center justify-between mb-4 px-2">
            <div className="flex items-center gap-3">
              {title ? (
                ...
                <button
                  onClick={onSave}
                  className="px-6 py-1.5 bg-[#00B7AD] text-white rounded-sm cursor-pointer hover:bg-blue-700 text-sm  transition-colors"
                >
                  Save
                </button>
              ) : (
                    ...
                    >
                      ...
                      <div
                        className={cn(
                          ...
                          isResizing === column.id && "bg-[#00B7AD]"
                        )}
                      />
                ...
                currentData.map((row, rowIndex) => (
                  ...
                  >
                    {columns.map((column) => (
                      ...
                      >
                        <div className="">
                          {getCellValue(row, column, startIndex + rowIndex)}
                        </div>
                      </td>
                    ))}
                      ...
                      >
                        {!pending ? (
                          ...
                          <div className="flex items-center justify-center gap-2">
                            <button
                              onClick={() =>
                                handleEdit(row, startIndex + rowIndex)
                              }
                            ...
                            <button
                              onClick={() =>
                                handleDeleteClick(row, startIndex + rowIndex)
                              }
                          ...
                          <div className="flex items-center justify-center gap-2">
                            <button
                              onClick={() =>
                                handleView(row, startIndex + rowIndex)
                              }
                            ...
                            <button
                              onClick={() =>
                                handleApprove(row, startIndex + rowIndex)
                              }
                            ...
                            <button
                              onClick={() =>
                                handleReject(row, startIndex + rowIndex)
                              }
        ...
        {showAddRowButton && onAddNewRow && (
          <div className="mt-4 flex items-center justify-center">
            <button
              onClick={onAddNewRow}
              className="inline-flex text-sm items-center justify-center  gap-2 px-4 bg-[#00B7AD] py-2 hover:bg-blue-700  rounded-lg text-white transition-colors"
            >
              <svg
                className="w-4 h-4"
                fill="none"
