...
export default function Transfer() {
  ...
  const transformedData: TableRow[] = transferResponse?.results?.map((item: TransferItem) => ({
  ...
  const handleDelete = async (row: TableRow) => {
    ...
    if (transferStatus !== 'pending') {
      toast.error(`Cannot delete transfer with status "${transferStatus}". Only pending transfers can be deleted.`);
      return;
    }
