...
export default function Reports() {
  ...
  const [selectedBudget, setSelectedBudget] = useState<string>("MIC_HQ_MONTHLY");
  const [isChangingSelection, setIsChangingSelection] = useState<boolean>(false);
  ...
  const transformedData: TableRow[] = reportResponse?.data?.data?.map((item: BalanceReportItem, index: number) => ({
    id: index + 1,
      ...
      {!selectedPeriod || !selectedBudget ? (
        ...
        <div className="flex justify-center items-center h-64 bg-white rounded-lg">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              {searchQuery ? 'No data found matching your search' : 'No report data found'}
            </p>
            {searchQuery && (
              <button 
        ...
        <div>
          ...
          <SharedTable
            ...
            totalCount={reportResponse?.data?.total_records || reportResponse?.data?.count}
