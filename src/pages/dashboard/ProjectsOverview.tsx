...
<path d="M9.03516 12.9834H13.333" stroke="#757575" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M8.46158 3.11747C8.92122 2.56814 9.74749 2.48758 10.3082 2.93788C10.3392 2.96231 11.3353 3.73614 11.3353 3.73614C11.9513 4.10852 12.1427 4.90018 11.762 5.50431C11.7417 5.53667 6.11013 12.581 6.11013 12.581C5.92277 12.8147 5.63836 12.9527 5.33441 12.956L3.17774 12.9831L2.69181 10.9264C2.62374 10.6372 2.69181 10.3335 2.87917 10.0997L8.46158 3.11747Z" stroke="#757575" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M7.41992 4.4248L10.6509 6.90606" stroke="#757575" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
  ...
  return (
    <div>
      {/* Page Title */}
      <h1 className="text-2xl font-bold tracking-wide mb-6">Projects Overview</h1>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <span className="ml-2 text-gray-900">{String(selectedAccount.id)}</span>
                  </div>
                  <div>
                    <span className="font-medium text-gray-700">Username:</span>
                    <span className="ml-2 text-gray-900">{String(selectedAccount.username)}</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-gray-700">Source Allowed</span>
                    <div className="flex gap-2">
                      <label className="flex items-center">
                        <input 
                          ...
                          name="sourceAllowed" 
                          value="Yes"
                          defaultChecked={selectedAccount.sourceAllowed === 'Yes'}
                          className="mr-2"
                        />
                        Yes
                      </label>
                      <label className="flex items-center">
                        <input 
                          ...
                          name="sourceAllowed" 
                          value="No"
                          defaultChecked={selectedAccount.sourceAllowed === 'No'}
                          className="mr-2"
                        />
                        No
                      </label>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-gray-700">Target Allowed</span>
                    <div className="flex gap-2">
                      <label className="flex items-center">
                        <input 
                          type="radio" 
                          name="targetAllowed" 
                          value="Yes"
                          defaultChecked={selectedAccount.targetAllowed === 'Yes'}
                          className="mr-2"
                        />
                        Yes
                      </label>
                      <label className="flex items-center">
                        <input 
                          ...
                          name="targetAllowed" 
                          value="No"
                          defaultChecked={selectedAccount.targetAllowed === 'No'}
                          className="mr-2"
                        />
                        No
                      </label>
                    ...
                    <div className="flex gap-2">
                      <label className="flex items-center">
                        <input 
                          ...
                          value="Yes"
                          defaultChecked={selectedAccount.transferAllowed === 'Yes'}
                          className="mr-2"
                        />
                        Yes
                      </label>
                      <label className="flex items-center">
                        <input 
                          ...
                          name="transferAllowed" 
                          value="No"
                          defaultChecked={selectedAccount.transferAllowed === 'No'}
                          className="mr-2"
                        />
                        No
                      </label>
